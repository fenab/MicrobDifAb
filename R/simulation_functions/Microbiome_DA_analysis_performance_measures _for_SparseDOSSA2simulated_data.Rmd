...
```{r, echo=TRUE}
nMicrobes <- nMicrobes# 717 #303
readDepth<- readDepth #3534 #1883
...
#FDR
rResults1All2=subset(rResults1All,effectSize==3)
...
rResults1All5=subset(rResults1All,effectSize==4)
...
rResults1All10=subset(rResults1All,effectSize==5)
